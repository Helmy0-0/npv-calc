...
@section('title', 'Project Data Input')
        ...
        <form action="{{ route('npv.calculate') }}" method="POST" id="npv-form">
            ...
            <div class="form-grid" style="margin-bottom: 2rem;">
                ...
                <div class="form-group span-2">
                    ...
                    <input type="text" name="project_name" placeholder="example: Construction of Unit B Factory"
                        value="{{ old('project_name') }}" autocomplete="off" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap has-prefix">
                        ...
                        <input type="number" name="initial_investment" placeholder="500,000,000"
                            value="{{ old('initial_investment') }}" min="0" step="any" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap has-suffix">
                        <input type="number" name="discount_rate" placeholder="10" value="{{ old('discount_rate') }}"
            ...
            <div id="cashflow-container">
                <div class="cashflow-row" data-index="0">
                    ...
                    <div class="input-wrap has-prefix">
                        <span class="prefix">Rp</span>
                        <input type="number" name="cash_flows[]" placeholder="Cash flow for year-1"
                            value="{{ old('cash_flows.0') }}" step="any" required>
                    </div>
                    <div></div>
                </div>
            </div>
        ...
        (function () {
            ...
            function createRow(yearNumber) {
                ...
                row.innerHTML = `
                    ...
                    <button type="button" class="btn-remove" title="Delete this year">×</button>
                `;
